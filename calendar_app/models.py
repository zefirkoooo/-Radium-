...
class Meal(models.Model):
    ...
    is_complete_dish = models.BooleanField(default=False,
                                           help_text="Является ли блюдо полноценным (не требует гарнира)")
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['is_complete_dish']),
            models.Index(fields=['excel_row']),
        ]
...
class UserSelection(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['user', 'day_menu']),
            models.Index(fields=['day_menu']),
            models.Index(fields=['user']),
            models.Index(fields=['not_eating']),
        ]
